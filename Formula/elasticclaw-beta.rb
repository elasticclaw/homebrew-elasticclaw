class ElasticclawBeta < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "8f4d6b1638670c4071296224b30485afe371bc956edc835d34f672a5dcc455f8"
    end
    on_intel do
      url "https://github.com/elasticclaw/elasticclaw/releases/download/#{version}/elasticclaw-darwin-amd64"
      sha256 "65fbe4fdc210dd58f8f8c5bc01abe0962e67c3c597cf99d17d3b56003349978f"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "5a5a5978ce83daa250ee4d768413476d120ffeffd4dd93f87d84cb91b5ff8b7d"
    end
    on_intel do
      url "https://github.com/elasticclaw/elasticclaw/releases/download/#{version}/elasticclaw-linux-amd64"
      sha256 "fe85b8ac84552ef6611140bec1fccad1411ea3c32010ae07e8d1c825ce719ea7"
    end
  end
