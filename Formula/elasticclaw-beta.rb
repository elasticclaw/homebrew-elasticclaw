class ElasticclawBeta < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "47488205440003d9dbfbce3d1119cc734ddc9d7bb55585c9c4f28ffa07520b13"
    end
    on_intel do
      url "https://github.com/elasticclaw/elasticclaw/releases/download/#{version}/elasticclaw-darwin-amd64"
      sha256 "7cb2b4097b05286b8bca27adff1bd76fcca5799b554ce66ffc687a72a279dc00"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "1d4c47863ba9e4fcb2594619a2baf177d67c138f722ff6769d9722456e1f3e14"
    end
    on_intel do
      url "https://github.com/elasticclaw/elasticclaw/releases/download/#{version}/elasticclaw-linux-amd64"
      sha256 "6915e36cf1f501bc3c9f7f25309deac453fba15a0ab9d45c70ef8cf49af2ff14"
    end
  end
