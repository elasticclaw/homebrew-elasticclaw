class ElasticclawBeta < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "c6b3f94d0122be4eee837836a38937ba656c6abd5e5ae8caaa99553b4c21ff92"
    end
    on_intel do
      url "https://github.com/elasticclaw/elasticclaw/releases/download/#{version}/elasticclaw-darwin-amd64"
      sha256 "12c8b5aac48fae93339bbc4b351dab6526270b587d7f260320125c73e0e67475"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "24da53262d0a54727048a752c9c88bb9507a3d3f13fbc4268aa4cb394111e772"
    end
    on_intel do
      url "https://github.com/elasticclaw/elasticclaw/releases/download/#{version}/elasticclaw-linux-amd64"
      sha256 "47f618dd6ce8695cbf1164dc4ef1d4b377dda06eeccd2a5a832287d14eed5466"
    end
  end
